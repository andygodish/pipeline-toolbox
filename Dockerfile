FROM chainguard/wolfi-base:latest@sha256:0cff4df29a6597173dc8b813787318150141eb96ac783dc3ff4f5ff52c49a1e2
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.31.0/uds-cli_v0.31.0_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
