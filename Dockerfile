FROM chainguard/wolfi-base:latest@sha256:3e3a125c18346ee7b95980be96529d39eb9f799e140aab2b02218a1bd67bfb18
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.27.15/uds-cli_v0.27.15_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
