FROM chainguard/wolfi-base:latest@sha256:77891a12dc762228955294f2207ee1cbd2b127f18dc7c7458203116288dce828
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.27.18/uds-cli_v0.27.18_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
