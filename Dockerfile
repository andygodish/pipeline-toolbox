FROM chainguard/wolfi-base:latest@sha256:3258be472764337fd13095bcbb3182da170243b5819fd67ad4c0754590588b31
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.30.4/uds-cli_v0.30.4_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
