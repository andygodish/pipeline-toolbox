FROM chainguard/wolfi-base:latest@sha256:a31344ab2cb8618db84f535eec56f76f6178b142cb92cb2e48676cc2dcebea72
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.36.0/uds-cli_v0.36.0_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
