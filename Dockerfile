FROM chainguard/wolfi-base:latest@sha256:30f03343947c7ae3581fda727a6e2aa7b8ce7009b7bfc2ab8d5c9483ace5812f
...
# Install hadolint
RUN curl -L https://github.com/hadolint/hadolint/releases/download/v2.15.1/hadolint-Linux-x86_64 --output /usr/bin/hadolint && \
    chmod +x /usr/bin/hadolint

# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.35.1/uds-cli_v0.35.1_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
