FROM chainguard/wolfi-base:latest@sha256:1d95114038f76513a9ace6fca107d5582b08c65981f81f61cb56bf7fd2ef216d
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.38.0/uds-cli_v0.38.0_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
