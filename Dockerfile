FROM chainguard/wolfi-base:latest@sha256:9608820b6ea4da8bcf16989dac37a280f8f1fa0022efc45b5ed4b1ac1f634a79
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.27.16/uds-cli_v0.27.16_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
