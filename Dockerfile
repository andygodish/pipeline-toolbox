FROM chainguard/wolfi-base:latest@sha256:1af610c4a70668dad46159ee178b20378c79a49b554f76405670fc442d30183a
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.30.3/uds-cli_v0.30.3_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
