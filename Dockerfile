FROM chainguard/wolfi-base:latest@sha256:00f9662b838432de5f24eabe5dc86f20d1510d158eda1bcaf68bbba8412544cc
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.29.0/uds-cli_v0.29.0_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
