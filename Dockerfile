FROM chainguard/wolfi-base:latest@sha256:1fd981aa0bcefd8da87ce55a9ae907862fcb6835c658fdb284867117fb0268ce
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.27.11/uds-cli_v0.27.11_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
