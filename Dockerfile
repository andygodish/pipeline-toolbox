FROM chainguard/wolfi-base:latest@sha256:cb5d1d9d5d562191f7f1c37c2ee21e8a9cdf3d25bf1faa4ac10ee375597ef9db
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.27.6/uds-cli_v0.27.6_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
