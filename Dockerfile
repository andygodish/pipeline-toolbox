FROM chainguard/wolfi-base:latest@sha256:72de158dcb2951c4815e016c1a7804af4e1af98d1d1922c1565a85b5987fbe43
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.27.9/uds-cli_v0.27.9_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
