...
# Install hadolint
RUN curl -L https://github.com/hadolint/hadolint/releases/download/v2.13.1/hadolint-Linux-x86_64 --output /usr/bin/hadolint && \
    chmod +x /usr/bin/hadolint

# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.27.13/uds-cli_v0.27.13_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
