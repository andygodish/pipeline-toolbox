FROM chainguard/wolfi-base:latest@sha256:2f7a5c164eafbdbe46fe1d91bd1ab4c8cb5c2bdbd10641c3d61bd39962384cdb
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.34.0/uds-cli_v0.34.0_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
