FROM chainguard/wolfi-base:latest@sha256:0c35d31660ee8ff26c0893f7f1fe5752aea11f036536368791d2854e67112f85
...
# Install UDS CLI
RUN curl -L https://github.com/defenseunicorns/uds-cli/releases/download/v0.27.5/uds-cli_v0.27.5_Linux_amd64 --output /usr/bin/uds && \
    chmod +x /usr/bin/uds
